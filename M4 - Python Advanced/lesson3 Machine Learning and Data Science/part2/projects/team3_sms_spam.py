#!/usr/bin/env python3
"""
Team 3 — SMS Spam (Text Classification)

Dataset: ucirvine/sms_spam   (Hugging Face)
Modality: text (binary)

Goal
----
Detect spam vs ham SMS. Target: ≥97% accuracy and F1 ≥ 0.95.

Suggested path
--------------
- TF-IDF (unigrams+bigrams, cap vocab ~20k) + Logistic Regression; compare Linear SVM.
- Stratified split; report accuracy/precision/recall/F1 + confusion matrix.
- Inspect top weighted features; show 10 hardest examples.

Stretch ideas
-------------
- Probability calibration; try character n-grams.
...
def load_data(dataset_id: str = "ucirvine/sms_spam"):
